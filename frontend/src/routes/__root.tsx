...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PolicyWise — Explore, Calculate & Apply for Insurance Policies" },
      { name: "description", content: "A modern customer portal to browse insurance policies, calculate premiums, apply online, track applications and chat with an AI assistant." },
      { property: "og:title", content: "PolicyWise" },
      { property: "og:description", content: "Browse insurance policies, calculate premiums, apply online and manage your insurance in one modern dashboard." },
